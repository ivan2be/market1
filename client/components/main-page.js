...
const Main = () => {
  ...
  return (
    <div className="flex flex-row flex-wrap content-around justify-around">
      {switchSortItems(sortStatus, items).map((it) => {
        return (
          <div key={it.id} className="flex px-6 py-6">
            <div className="flex flex-col box-content h-64 w-64 border-2 border-gray-400">
              <img
                id="card__image"
                alt="img"
                src={it.image}
              ...
              <div className="flex flex-col">
                ...
                <div className="text-center text-xs">{it.description}</div>
